[![ссылка на картинку](logo.png)](https://ru.wikipedia.org/wiki/Python)
***
## 1. ___Установка___
_Начало работы с языком Python. Установка и проверка версии интерпретатора. Команды для терминала, написагте первой программы Hello World в IDLE, Terminal и VS Code. Расширения для работы с Python в редаткоре VS Code._
***
## 2. ___Строки___ 
_Как устроены строки на языке Python. Разные виды кавычек и способы экранирования кавычек для их отображения. Вывод текста на экран. Создание первой переменной._
***
## 3. ___Арифметика___
_Рассматриваем арифметические операторы. Способы возведения в степень и извлечение квадратного корня. Сокращения для операторов. Побитовые операторы._
***
## 4. ___Логика___
_Рассмотрим операторы сравнения на Python. Логический тип данных bolean и его значения True и False. Синтаксис условных конструкций if elif else._
***
###### Логические операции
_Логическое И (AND)_                                          
x1 | x2 | x1 and x2
...
__Шпаргалка__
![шпора](python.jpg)
 ___Ссылки на полезные видео уроки:___
 1. [Основы программирования на примере Java Script](https://www.youtube.com/watch?v=2yT8jMgWvko)
 2. [ООП на Java Script](https://www.youtube.com/watch?v=4rkj2CUpzpE)
 3. [ООП на PHP](https://www.youtube.com/watch?v=LJCfPmbU4sc&feature=youtu.be)
 4. [Квадратное уравнение на Java Script](https://www.youtube.com/watch?v=daJgnaNC_1U)
 5. [Блок-схемы алгоритмов](https://www.youtube.com/watch?v=uY0I4c3nwfA&feature=youtu.be)
 ___Литература (онлайн PDF):___
 1. [A Byte of Python - Swaroop Chitlur](https://wombat.org.ua/AByteOfPython/AByteofPythonRussian-2.02.pdf)
 2. [Грокаем алгоритмы - Адитья Бхаргава](https://kitobz.com/upload/Грокаем%20алгоритмы-%20%20www.kitobz.com.pdf)
 3. [Основы программирования на примере языка Python - Д. Ю. Федоров](https://dfedorov.spb.ru/python3/book.pdf)
 4. [Изучаем Python - Mark Lutz](http://uchcom7.botik.ru/L/prog/python/python_01.pdf)
